...
void BSP_I2C1_Init()
{
	...
	I2C1->TIMINGR |= ((16 -1) <<I2C_TIMINGR_PRESC_Pos); // Clock prescaler /16 -> 4MHz
	I2C1->TIMINGR |= (40 	 <<I2C_TIMINGR_SCLH_Pos);  // High half-period = 5µs
	I2C1->TIMINGR |= (40     <<I2C_TIMINGR_SCLL_Pos);  // Low  half-period = 5µs
